            ...
            <div className="basis-1/4">
                ...
                <div className="w-full mt-5 max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                    <div className="flex flex-col items-center pt-5 pb-5">
                        <img className="w-24 h-24 mb-3 rounded-full shadow-lg" src={ user.avatar || "https://cached.imagescaler.hbpl.co.uk/resize/scaleWidth/952/cached.offlinehbpl.hbpl.co.uk/news/ORP/B4034D5B-B9CD-0FDA-A4A4B94A79E70949.jpg"} alt="Bonnie image"/>
                        ...
                        <div className="mt-6">
                            ...
                            <div><Link className={`${activeTab === 'update_credentials' ? 'text-gray-500' : 'text-blue-500'} font-medium pl-1 hover:underline`} onClick={() => setActiveTab('update_credentials')}> Update credentails</Link></div>
                            <div><Link className={`${activeTab === 'update_password' ? 'text-gray-500' : 'text-blue-500'} font-medium pl-1 hover:underline`} onClick={() => setActiveTab('update_password')}> Update password</Link></div>
                        </div>
                    </div>
                </div>
            </div>
